...
from tssl.configs.kernels.base_elementary_kernel_config import BaseElementaryKernelConfig
...
from tssl.configs.prior_parameters import (
    KERNEL_LENGTHSCALE_GAMMA,
    KERNEL_VARIANCE_GAMMA,
)


class BasicMatern52Config(BaseElementaryKernelConfig):
...
class Matern52WithPriorConfig(BasicMatern52Config):
    add_prior: bool = True
