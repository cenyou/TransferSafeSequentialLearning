...
class TransferTaskGEngineConfig(BaseSimulatorConfig):
    n_pool: int
    data_path: str
    ...
    seed: int=1234
    name: str='transfer_task_gengine'

class TransferTaskGEngineTestConfig(TransferTaskGEngineConfig):
    name: str='transfer_task_gengine_test'